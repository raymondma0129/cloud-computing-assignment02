...
FROM 'C:\\Program Files\\PostgreSQL\\17\\data\\assn02\\gtfs_public\\google_bus\\stops.txt'
DELIMITER ',' 
CSV HEADER;
...
FROM 'C:\\Program Files\\PostgreSQL\\17\\data\\assn02\\gtfs_public\\google_bus\\routes.txt'
DELIMITER ',' 
CSV HEADER;
...
FROM 'C:\\Program Files\\PostgreSQL\\17\\data\\assn02\\gtfs_public\\google_bus\\trips.txt'
DELIMITER ',' 
CSV HEADER;
...
FROM 'C:\\Program Files\\PostgreSQL\\17\\data\\assn02\\gtfs_public\\google_bus\\shapes.txt'
DELIMITER ',' 
CSV HEADER;
...
FROM 'C:\\Program Files\\PostgreSQL\\17\\data\\assn02\\gtfs_public\\google_rail\\stops.txt'
DELIMITER ',' 
CSV HEADER;
...
FROM 'C:\\Program Files\\PostgreSQL\\17\\data\\assn02\\pop2020.csv'
DELIMITER ',' 
CSV HEADER;

SELECT * FROM census.blockgroups_2020 LIMIT 5;
